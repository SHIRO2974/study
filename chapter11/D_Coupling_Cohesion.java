...
/*      === 결합도 & 응집도 ===
        ...
        >> 모듈의 독립성을 결합도(Coupling)와 응집도(Cohesion)의 기준단계로 측정

        1. 결합도 (낮은 결합도)
         두 모듈 간의 의존 관계의 강도를 나타타내는 척도
         즉 하나의 모듈이 다른 모듈에 얼마나 의존하는지 의미!
         프로그램을 유지보수하기 쉽게 만들고,
        ...
        2. 응집도 (높은 응집도)
         하나의 모듈 내에서 구성요소들이 얼마나 밀접하게 관련되어 있는지 나타내는 척도
         즉 한 모듈 내의 구성요소들 간의 연관 정도
         자기 자신의 책임에 집중하게 하여 코드가 이해하기 쉽고 유지보수 용이

         높은 응집도: 하나의 모듈이 관련된 일들만 하고, 해당 일이 잘 명시 !

         === 결합도와 응집도 관계 ===
            낮은 결합도 + 높은 응집도
            각 모듈이 독립적으로 동작하면서도, 본인의 작업에 충실
            >> 유지보수가 쉽고 확장성이 좋음
...
/*
            2-2 캡슐화
            필드를 private 설정, getter 와 setter 통해 접근
...
public class D_Coupling_Cohesion {
    public static void main(String[] args) {
        ...
        orderClass.checkout();  // 신용카드로 결제합니다.
