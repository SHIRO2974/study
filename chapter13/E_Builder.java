...
/*      === Builder 패턴 ===
           1. 빌더 패턴이란?
            ...
            - 필드가 많거나, 필수 값과 선택 값이 섞여 있을 때 유용
           ...
           2. 빌더 패턴
             ...
             4) 빌더 패턴 동작 원리
                객체를 생성하는 데 필요한 데이터를 저장하는 Builder 클래스를 생성
                Builder 클래스는 원하는 속성을 단계별로 설정할 수 있는 메서드 제공
...
public class E_Builder {
    public static void main(String[] args) {
        ...
        Pizza builderPizza = new Pizza.Builder("피자","M")
                .build();
        ...
        Pizza pizza2 = new Pizza.Builder("고구마 피자","M")
                .addPepperoni().addMushrooms().build();
