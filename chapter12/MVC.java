...
/*
         ...
         : Model 의 정보를 표시, 사용자의 액션을 Controller 에게 전달
...
class LunchMenuView {
    ...
    public void displayMenu(String menu) {
        System.out.println("오늘의 급식 메뉴: " + menu);
    }
}

//      Controller: Model 과 View 를 연결하는 역할
class LunchMenuController {
    private LunchMenu model;
    private LunchMenuView view;

    public LunchMenuController(LunchMenu model, LunchMenuView view) {
        this.model = model;
        this.view = view;
    }
...
*/
    public static void main(String[] args) {
        ...
        LunchMenuView view = new LunchMenuView();

        LunchMenuController controller = new LunchMenuController(menu, view);
