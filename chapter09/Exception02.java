...
/*      == throws 키워드 ==
          ...
          (접근 제한자) 반환타입 메서드명() throws ExceptionType {}

        == throw 키워드 ==
           메서드 내부에 위치
           예외를 발생시킴
          - throw new ExceptionType("에러 메세지")


  Throwable: 예외(Exception) _ 오류(Error)
*/
...
//    2) 여러 에외 던지기
    ...
    public static void main(String[] args) {
        // == 사용자 정의 예외 사용 ==
        // throw  new CustomException2("예외 처리 되지않는 예외");
...
//          catch 블럭의 예외객체인 'e'
//          주로 객체변수는 Exception 의 철자를 사용하여 'e' 로 명시
            System.out.println("정수가 아닌 다른타입의 입력이 작성됨.");
        ...
        try {
            System.out.println("여러 예외 던지기 테스트");    // 여러 예외 던지기 테스트
            exceptions(1);

        } catch (ArithmeticException e) {

            System.out.println("예외 처리1: " + e.getMessage());    // 예외 처리1: 0으로 나눌 수 없습니다.
